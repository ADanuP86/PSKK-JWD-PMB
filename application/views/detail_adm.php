<div class="content-wrapper">
  <section class="content-header">
    <h1>
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('C_admin/cetak') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
    ...
    <section class="content">
      <a class="btn btn-warning" href="<?php echo base_url('C_admin/cetak') ?>"> <i class="fa fa-file"></i>Export PDF</a>
      ...
      <table class="table">
        ...
        <tr>
          ...
          <td><?php echo anchor('C_admin/edit/'.$swa->id, '<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?></td>
          </td>
        </tr>
