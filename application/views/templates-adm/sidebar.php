      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MAIN NAVIGATION</li>
         ...
         <li <?=$this->uri->segment(2) == 'detail' || $this->uri->segment(2) == '' ? 'class="active"' : '' ?> class="nav-item">
          <a href="<?php echo base_url('C_admin/detail') ?>" class="nav-link">
         ...
         <li <?=$this->uri->segment(2) == 'logout' || $this->uri->segment(2) == '' ? 'class="active"' : '' ?> class="nav-item">
          <a onclick="javascript: return confirm('Yakin Ingin Keluar?')" href="<?php echo base_url('C_login') ?>" class="nav-link">
